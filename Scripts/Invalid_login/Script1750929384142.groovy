...
WebUI.waitForElementVisible(findTestObject('Invalid_login/toast_massage'), 5)

String toastText = WebUI.getText(findTestObject('Invalid_login/toast_massage'))

println('Error message received: ' + toastText)

WebUI.verifyMatch(toastText, 'Invalid credentials.', false)
